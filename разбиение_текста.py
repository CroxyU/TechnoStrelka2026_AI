...
Original file is located at
    https://colab.research.google.com/drive/1z3ByZM624fxYkCjQ3bb3LXHYfiTdslMG
"""
...
def load_text_file(filepath: str) -> str:
    """
    Загружает текст из файла. Пробует разные кодировки.
    Возвращает строку с текстом или выбрасывает исключение.
    """
...
def clean_text(text: str) -> str:
    """
    Убирает лишние пробелы, табуляции, множественные переводы строк.
    """
...
def split_into_chapters(text: str) -> List[Dict[str, str]]:
    ...
    Возвращает список словарей: {'title': 'Глава 1', 'content': 'текст главы'}.
...
def process_book(filepath: str, book_id: str) -> List[Dict]:
    ...
    - загрузка текста
    - разбиение на главы (если возможно)
    - разбиение каждой главы на чанки
    - добавление метаданных
    Возвращает список словарей с ключами: book_id, chapter, chunk_index, text
    """
...
if __name__ == "__main__":
    chunks = process_book("test.txt", "test_book")
    for chunk in chunks:
